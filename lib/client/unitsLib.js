...
UnitsLib = new function() {
	...
	this.worldpos = function( xpix, ypix, xref, yref, xrefpix, yrefpix, xinc, yinc, rot, type) {
		// default: result is invalid
		var res = { ra: 0, dec: 0, success: false };
		...
		var dx = (xpix-xrefpix) * xinc;
		var dy = (ypix-yrefpix) * yinc;
		//   Take out rotation
		var cosr = Math.cos(rot*cond2r);
		var sinr = Math.sin(rot*cond2r);
		if (rot != 0.0) {
