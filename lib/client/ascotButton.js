...
(function () {
  ...
  function loadDependencies(callback){
    ...
    buttonCSS.href = 'http://ascot.astro.washington.edu/css/ascotButton.css';
  ...
  function init(){
    ...
    var buttonContent = 
        '<div class="clickedButtonState" style="display: none">' +
            '<img id="spinner" style="display: none" alt="dashboard loading" src="http://ascot.astro.washington.edu/images/ascotButton/spinner.gif">' +
        '</div>';
