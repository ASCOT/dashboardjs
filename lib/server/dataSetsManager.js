...
var queryLSST = function(queryInfo, callback){
...
var parseSDSSQueryResult = function(queryResult){
  // parse the XML
  var caca = libxmljs.parseXmlString(queryResult);
  return libxmljs.parseXmlString(queryResult).Row();
};

var parseLSSTQueryResult = function(queryResult){
};
