  ...
  Parser = (function(_super) {
    ...
    function Parser(arg, callback, opts) {
      ...
      if (typeof this.arg === 'string') {
      	...
      	// Note: This section was edited by Spencer Wallace to make use of
      	// xhrProxy when doing cross domain requests.
      	if (this.arg.substring(0, 7) === "http://") {
		    	var loadSuccess = function(response) {
		    		...
		    		_this.arg = byteArray.buffer;
		    		_this.length = byteArray.length;
		    		return _this.readFromBuffer();
		    	};
		    	
		    	$.ajax({
		    		'url': '/xhrProxy/' + encodeURIComponent(this.arg),
		    		success: loadSuccess
		    	});
      	}
      	else {
