...
function wrapTexture(texture) {
    return {
        _: texture,
        loadContentsOf: function(textureBytes) { this._.fromBytes(textureBytes); },
        destroy: function() { this._.destroy(); }
    };
}

function texture(textureBytes, width, height) {
    return wrapTexture(Texture.fromBytes(width, height, textureBytes));
}
...
var Texture = (function() {
    ...
    Texture.fromBytes = function(width, height, textureBytes) {
        var texture = new Texture(width, height, gl.RGBA, gl.UNSIGNED_BYTE);
        texture.initFromBytes(width, height, textureBytes);
        return texture;
    };
