AR = '/usr/bin/ar'
ARFLAGS = 'rcs'
CCFLAGS = ['-g', '-D_LARGEFILE_SOURCE', '-D_FILE_OFFSET_BITS=64']
...
CPPPATH_FFI = ['/opt/local/include']
CPPPATH_NODE = '/usr/local/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-D_LARGEFILE_SOURCE', '-D_FILE_OFFSET_BITS=64']
CXXFLAGS_DEBUG = ['-g']
...
LIBDIR = '/home/swallace/.node_libraries'
...
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/swallace/.node_libraries'
PREFIX = '/usr/local'
